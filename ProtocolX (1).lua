...
MobileBtnTopBar.Name = "MobileBtnTopBar"
MobileBtnTopBar.Parent = MobileBtn
MobileBtnTopBar.BackgroundColor3 = Color3.fromRGB(15, 50, 120)
MobileBtnTopBar.BackgroundTransparency = 0.25
MobileBtnTopBar.BorderSizePixel = 0
MobileBtnTopBar.Position = UDim2.new(0, 0, 0, 0)
MobileBtnTopBar.Size = UDim2.new(1, 0, 0, 18)
MobileBtnTopBar.ZIndex = 12

MobileBtnTopBarCorner.CornerRadius = UDim.new(0, 14)
MobileBtnTopBarCorner.Parent = MobileBtnTopBar

-- Blue side accent bar (left edge)
MobileBtnAccent.Name = "MobileBtnAccent"
MobileBtnAccent.Parent = MobileBtn
MobileBtnAccent.BackgroundColor3 = Color3.fromRGB(50, 130, 255)
MobileBtnAccent.BackgroundTransparency = 0
MobileBtnAccent.BorderSizePixel = 0
MobileBtnAccent.Position = UDim2.new(0, 0, 0, 14)
MobileBtnAccent.Size = UDim2.new(0, 3, 1, -14)
MobileBtnAccent.ZIndex = 12

MobileBtnAccentCorner.CornerRadius = UDim.new(0, 3)
MobileBtnAccentCorner.Parent = MobileBtnAccent

-- Big stylised "X" — the Protocol X logo mark
MobileBtnX.Name = "MobileBtnX"
MobileBtnX.Parent = MobileBtn
MobileBtnX.BackgroundTransparency = 1
MobileBtnX.BorderSizePixel = 0
MobileBtnX.Position = UDim2.new(0, 6, 0, 10)
MobileBtnX.Size = UDim2.new(1, -6, 0, 36)
MobileBtnX.Font = Enum.Font.GothamBold
MobileBtnX.Text = "X"
MobileBtnX.TextColor3 = Color3.fromRGB(80, 160, 255)
MobileBtnX.TextSize = 32
MobileBtnX.TextStrokeColor3 = Color3.fromRGB(0, 60, 180)
MobileBtnX.TextStrokeTransparency = 0.4
MobileBtnX.ZIndex = 13

-- Small "PROTOCOL" sub-label beneath the X
...
MobileBtnSub.Position = UDim2.new(0, 0, 0, 46)
